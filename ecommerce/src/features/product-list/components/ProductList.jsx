...
// import NavigationBar from "../menu-navigation/components/NavigationBar";
import { ChevronLeftIcon, ChevronRightIcon } from "@heroicons/react/20/solid";
import { Link } from "react-router-dom";
import { fetchAllProductsThunk, fetchFilteredProductsThunk, selectAllProducts } from "../slices/productSlice";
import { useDispatch, useSelector } from "react-redux";
// import {jsonProducts} from "../../../data.json";

//T2 Import Ends

// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// T1 const Begins: The below code is for the Tailwindcss template-2 (provides the fundtionality of sort, filter,etc.)

// T1 const Ends
// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// T2 const Begins: The below code is for the Tailwindcss template-2 (provides the fundtionality of sort, filter,etc.)
const sortOptions = [
...
const unique_categories_of_products = [...new Set(jsonProducts.map(p => p.category))];
// console.log(unique_categories_of_products)
const unique_brands_of_product = [...new Set(jsonProducts.map(p => p.brand))];
// console.log(unique_brands_of_product)

const filters = [
  {
    id: "category",
    name: "Category",
    options: unique_categories_of_products.map(c =>({  
  ...
  },
  {
    id: "brand",
    name: "Brands",
    options: unique_brands_of_product.map(c =>({  
      value: c, label: c, checked: false
      })),
  },
  // options: [
    ...
    //   { value: "government-exams", label: "Government Exams", checked: true },
    //   { value: "novels", label: "Novels", checked: false },
    //   { value: "religious", label: "Religious", checked: false },
    // ],
...
export default function ProductList() {
  ...
  const products = useSelector(selectAllProducts) // state.reducer.stateInsideReducer
  ...
  useEffect(() => {
    dispatch(fetchFilteredProductsThunk(filter))
  },[dispatch,filter]);
